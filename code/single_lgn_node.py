...
intra_pop_delay = RandomDistribution('uniform',(0,10))#4
intra_nucleus_delay = RandomDistribution('uniform',(0,10))#6
inter_nucleus_delay = RandomDistribution('uniform',(0,10))#8
inter_pop_delay = RandomDistribution('uniform',(0,10))#10
...
tcr_c_tonic = -65.0
tcr_d_tonic = 6.0
tcr_v_init_tonic = RandomDistribution('uniform',(-100,-25))#-65.0

in_a_tonic = 0.1
in_b_tonic = 0.2
in_c_tonic = -65.0
in_d_tonic = 6.0
in_v_init_tonic =RandomDistribution('uniform',(-100,-25))#-70.0#

trn_a_tonic = 0.02
trn_b_tonic = 0.2
trn_c_tonic = -65.0
trn_d_tonic = 6.0
trn_v_init_tonic = RandomDistribution('uniform',(-100,-25))#-75.0
...
tcr_u_init = RandomDistribution('uniform',(-100*tcr_b,-25*tcr_b))#tcr_b * tcr_v_init
in_u_init = RandomDistribution('uniform',(-100*in_b,-25*in_b))#in_b * in_v_init#
trn_u_init = RandomDistribution('uniform',(-100*trn_b,-25*trn_b))#trn_b * trn_v_init#

# a constant DC bias current; this is used here for testing the RS and FS
# characteristics of IZK neurons
current_Pulse = 10.0 #RandomDistribution('poisson',lambda_=10) #
...
def plot_raster(TCR_pop, IN_pop, TRN_pop):
...
# raster
plot_raster(TCR_pop,IN_pop,TRN_pop)
